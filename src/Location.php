 ...
 * in this location there are 5 persons. or 5 locations in one location.
 * 1- aa                    Root
 * 2- aa.bb                Grandfathers father
 * 3- aa.bb.cc            Grandfather
 * 4- aa.bb.cc.dd        Father
 * 5- aa.bb.cc.dd.ee    Child
 * so every person is connected with its parent by the separator to create new location.
 *
...
class Location
{
     ...
     * if set to 'chars' so segments in location will be generated by set of characters like: 'aa.dd'
     * if set to 'digits' so segments in location will be generated by set of digits like: '00.33'
     *
    ...
    /**
     * get REGEXP pattern for getting the root node in this tree
     *
     ...
     * Depending on config value of location_segment_unit
     * And the length of segment that will be generated depends
    ...
    /**
     * get REGEXP pattern for retrieving specific generation in this tree.
     *
     ...
     * the generation that given as second parameter
     *
     * @return string REGEXP pattern
     */
    ...
    /**
     * Determine if the given location is the root
     *
     * @param string $location
     * @return bool
     */
    ...
    /**
     * Determine if the given location is segment
     ...
     * Depending on mechanism the location segments are generated by [chars | digits]
     *
     * Ex: abf ----> abg
     * Ex: 045 ----> 046
     *
     ...
     *
     * Note: Here it does not detected if the the next location already exists or not
     *
     * @param string $location
     ...
     *
     * @param string $location
     * @return string|null new location which is new sibling to the given location
     */
    ...
    /**
     * Indicates which generation the given node location is
     *
     * @param string $location
     * @return int | NULL
     */
     ...
     *
     * @param string $location_1 possible father location
