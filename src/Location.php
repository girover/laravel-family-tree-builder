...
class Location
{
     ...
     * if set to 'chars' so segments in location will be generated by set of characters like: 'aaa.ddd'
     * if set to 'digits' so segments in location will be generated by set of digits like: '000.333'
     *
